...
| Нэвтрэлт | **Шаардлагагүй.** Бүртгэлгүй хүн агуулахын хуудаснаас и-мэйлээ оруулж, и-мэйлээр ирсэн нууц холбоосоор (`/contracts/g/<token>`) гэрээгээ байгуулна. Нэвтэрсэн каргогийн админ өмнөх шигээ `/admin/warehouse`-ээр. |
...
- Таван скрипт Supabase дээр ажилласан. Production-д `CRON_SECRET` тохируулагдсан эсэхийг шалгана.
