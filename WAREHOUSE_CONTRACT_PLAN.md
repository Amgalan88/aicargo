...
| Зай талбай | Хэмжээ (м²) заахгүй. **Хуваарилалтыг системд автоматжуулахгүй** — super admin батлахдаа каргод харагдах тэмдэглэлээр (`warehouseNote`) мэдэгдэнэ. `WarehouseSection` хасагдсан. |
| aicargo эрх | Эрх (`paidUntil`) дууссан карго ч гэрээ байгуулж **болно** — шалгалт хийхгүй. |
| Нэвтрэлт | **Шаардлагагүй, и-мэйлээс хамааралгүй.** Бүртгэлгүй хүн агуулахын хуудаснаас холбоо барих и-мэйлээ оруулмагц гэрээ шууд вэб дээр (`/contracts/g/<token>`) нээгдэнэ; холбоос хөтөчид хадгалагдаж, и-мэйлээр нөөц болж очно. Баталгаажуулалт нь и-мэйлийн кодгүй — нөхцөл зөвшөөрөх + нэр бичих (IP, төхөөрөмж бүртгэгдэнэ). Нэвтэрсэн каргогийн админ өмнөх шигээ `/admin/warehouse`-ээр. |
| Вэбсайтын бэлэг | Гэрээ хүчин төгөлдөр болоход карго вэбсайт **60 хоног үнэгүй**. Бүртгэлтэй каргын эрх 60 хоногоор сунгагдана; бүртгэлгүй хүнд "Каргогоо нээх" санал (`/signup-cargo?contract=<token>`) гарч, нээхэд 60 хоногийн эрхтэй болж гэрээ шинэ каргод шилжинэ. Карго нээх нь тусдаа урсгал хэвээр. |
| Цэс | "Эрээний агуулах" цэс зөвхөн агуулахтай гэрээтэй каргод харагдана. |
| QPay | Судалж байгаа — одоохондоо хийхгүй. |
...
**Явц (2026-09-17):**
- Фаз 1 ✅ агуулахын тохиргоо + галерей (`scripts/add-warehouse-profile-gallery.ts`)
- Фаз 2 ✅ өөрчлөлтийн түүх `WarehouseLog` (`scripts/add-warehouse-log.ts`); зай талбайн бүртгэл хасагдсан
- Фаз 3 ✅ цахим гэрээ: хоёр хэлтэй загвар засагч, карго бөглөх → и-мэйл OTP → төлбөр мэдэгдэх → super admin батлах → PDF, цуцлалт (30 хоног), cron, баталгаажуулах хуудас (`scripts/add-warehouse-contracts.ts`)
- Зочны (нэвтрэлтгүй) гэрээ ✅ (`scripts/add-guest-contracts.ts`)
- "Үнэгүй хашаа 9-24" агуулахыг (id 1) "Наран тээвэр" ХХК-ийн мэдээлэл, данс, загвар v1-ээр тохируулж гэрээ хүлээн авдаг болгосон — `/warehouses/naran-teever/contract`. "Үнэгүй хашаа 5-24" (id 2)-ын хуулийн мэдээлэл, данс хараахан алга.
- 60 хоногийн вэбсайт бэлэг ✅ (`scripts/add-contract-website-bonus.ts`)
- Гэрээг и-мэйлгүйгээр вэб дээр шууд байгуулах ✅ (`scripts/add-guest-contracts-web.ts`)
- Зургаан скрипт Supabase дээр ажилласан. Production-д `CRON_SECRET` тохируулагдсан эсэхийг шалгана.
- Үлдсэн: QPay, хятад орчуулгыг агуулахаар батлуулах, хуульчийн хяналт, Фаз 5
