...
| Нэвтрэлт | **Заавал карго нээсэн байна** (2026-09-18). Бүртгэлгүй хүн гэрээ эхлүүлэх боломжгүй — агуулахын хуудас "Карго нээх / Нэвтрэх" рүү чиглүүлнэ. Гэрээ, төлбөрийн явц каргогийн админы **"Агуулах"** цэсэнд (бүх каргод харагдана). Өмнө эхэлсэн зочны гэрээ (`/contracts/g/<token>`) хэвээр ажиллана. |
